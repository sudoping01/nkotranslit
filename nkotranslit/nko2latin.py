...
class Nko2Latin(OrthographyConverter):
   ...
   ### NUMERALS:
    ...
    def convert(self, sentence):
        ...
        for word in sentence.split():
            if "\u07f5" in word or "\u07f4" in word:   # N’Ko apostrophes
                # Split on both N'Ko apostrophes: 07F4 (high) and 07F5 (low)
                parts = re.split("[\u07f4\u07f5]", word)
                converted_parts = []
                for part in parts:
                    if part:  # skip empty
                        converted = self._convert(part)[0]
                        converted_parts.append(converted)
                # Join with Latin apostrophe
...
#     "ߌ ߦߋ ߛߊ߲ ߖߏߟߌ ߦߋ",
#     "ߡߌ߲ ߓߍ ߘߋߟߌ ߞߊ ߞߍ",
#     "ߏ ߕߊߡߌߙߊ߸ ߣߋ ߦߙߍ ߞߙߐߞߍ ߡߙߊߕߎ ߓߟߊ߸ ߏ ߛߜ߭ߌߙߊ ߏ ߣߐ ߟߊ߷ ߏ ߛߜ߭ߌߙߊ ߏ ߣߐ ߟߊ߸ ߏ ߝߣߊ ߓߊ߲ߣߋ߲߸ ߣߋ ߘߋ ߕߜ߭ߎߙߊ ߏ ߟߊ߷ ߣߋ ߘߋ ߛߜ߭ߌߙߊ߸ ߥߺߊ߸ ߊߟߎ ߡߊ ߛߐ߲ ߏ ߡߊ߷",
#     "ߓߌ ߣߌ ߛߣߌ ߡߜ߭ߐߥ ߞߊ ߞߊ߲ ߞߵߎ ߛ߲ߛߌ߲ ߡߌ߲ߣߎ ߞߊ߲",
#     "ߞߊ ߤߊߞߟߌ ߕߏ ߝߣߊ ߦߙߍߡߊߤߙߐߦߊ ߕߓߜ߭ߊߥ ߞߊ ߤߊߞߟߌߟߊߥ ߟߊ"
#     ]
